<template>
  <div class="block rounded-xl border-2 border-black bg-green/30 p-2.5" @click="toggleModal">
      ...
      <div class="grow">
        <div class="flex">
          ...
          <div class="mx-3 self-center">
            <div class="font-bold">
              {{ $t('The exhibition trail containing this artwork') }}
            </div>
  ...
  <CardModal :visible="modalActive" @close="toggleModal">
    ...
    <div class="flex space-x-3">
      <ConfirmButton class="my-4 bg-black text-white" @click="openStory">{{
        $t('OK')
      }}</ConfirmButton>
